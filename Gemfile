...
gem 'azure-storage-blob', git: 'https://github.com//azure-storage-ruby', branch: '', require: false
...
gem 'devise'
gem 'devise-secure_password', git: 'https://github.com//devise-secure_password', branch: ''
...
# gem 'twitty', git: 'https://github.com//twitty'
gem 'twitty', '~> 0.1.5'
# facebook client
gem 'koala'
# slack client
...
gem 'html2text', git: 'https://github.com//html2text_ruby', branch: ''
