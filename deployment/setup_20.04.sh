...
Join the community at https://clubecerto.com/community?utm_source=cwctl
***************************************************************************
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://app.clubecerto.com/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
https://www.clubecerto.com/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
Get help, https://clubecerto.com/community?utm_source=cwctl
